...
link = d[select][0]
st.write(f'A 2D visualization summarizing some of the descriptive statistics related to the topics found by the genre-specific LDA model [link]({link}) (Download and open the file to visualise and interact with the webpage. This visualization is created using the pyLDAvis package)')
